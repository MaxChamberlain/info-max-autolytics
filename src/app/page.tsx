...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className='w-2/3 aspect-square rounded-full bg-gradient-to-r from-[#F90] from-8.85% via-[#F63333] via-25% to-[#00E0FF] to-100% blur-[12rem] absolute -top-2/3 -z-50 opacity-60'></div>
      <div className='w-screen flex flex-col items-center justify-center gap-16' style={{ height: 'calc(100vh - 8rem)' }}>
        ...
        <div className='w-fit py-4 px-8 text-white text-center bg-[#3D495E]/60 hover:bg-[#3D495E]/90 rounded-full text-lg cursor-pointer transition-colors duration-300 flex items-center gap-2'>
            Try It Out
      ...
      />
      <div className='w-full px-32 flex items-center justify-center gap-12 text-center -mt-64 z-50'>
        <div className='flex flex-col justify-around w-2/3 gap-32 items-center'>
          <span className='text-6xl font-bold text-white text-center w-full max-w-lg'>
            Our Strategy
          </span>
          <span className='text-xl text-white w-full max-w-2xl text-left'>
        ...
        <div className='w-full' style={{ perspective: 1500 }}>
          <div className='w-full p-4 rounded-xl backdrop-blur-xl bg-[#3D495E]/60' style={{ transform: 'rotateY(-10deg)' }}>
